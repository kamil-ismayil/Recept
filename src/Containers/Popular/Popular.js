import React, { useEffect, useState, useContext, Card } from "react";
...
const popular = (props) => {
			...
			return (
				...
				(
					<Link
						class="foodBox"
						to={{
							pathname: "/recepter/popular/" + x.id,
							state: { info: popularInfo },
						}}
					>
	...
	return <div className="popular">{popularElements}</div>;
};
