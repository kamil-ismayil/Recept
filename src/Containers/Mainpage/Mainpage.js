...
const mainpage = (props) => {
    ...
    return(
        <div className="mainpage">
            <div className="">
                <h3>Mat</h3> 
                <p>Alla ställer vi oss frågan, vad ska vi äta till middag idag? För att du ska slippa fundera på den frågan så har vi förbättrat vår sida, lyssnat på våra kunders tips och önskemål och samlat alla våra recept på mat här! Här kan du enkelt söka recept efter den huvudingrediens du vill ha, eller inspireras av olika typer av recept. Under typ av recept hittar du allt ifrån grytor, Tacos, pannkakor till soppor.
                </p>    
                <p>    
